...
1. Copy `.env.example` to `.env` and fill your Firebase keys (do not commit `.env`).
2. For production/EAS builds, prefer CI/EAS secrets instead of committing env files.

Example `.env.example` is included in the repository.
```

...
const styles = StyleSheet.create<{
  ...
  dayCellSelected: { backgroundColor: '#E5F0FF' },
  dayLabel: { color: Colors.light.text },
  dayLabelSelected: { color: Colors.light.tertiary, fontWeight: '700' },
  addBtn: {
  ...
  desc: { color: Colors.light.text, opacity: 0.8, marginTop: 4 },
  meta: { color: Colors.light.text, opacity: 0.7, marginTop: 6 },

...
AGENT_EDGES = [
    ('design-docs',  'architect',    'flow'),
    ('architect',    'engineer',     'flow'),
    ('engineer',     'reviewer',     'flow'),
    ('engineer',     'architect',    'retry'),
    ('quality',      'architect',    'retry'),
    ('reviewer',     'architect',    'dependency'),
    ('pr-lifecycle', 'quality',      'flow'),
    ('pr-lifecycle', 'reviewer',     'dependency'),
    ('test-writer',  'engineer',     'dependency'),
    ('design-docs',  'pr-lifecycle', 'flow'),
    # Security agents
    ('quality',              'security-orchestrator', 'flow'),
